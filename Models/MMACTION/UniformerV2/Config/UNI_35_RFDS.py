# Contributed by Michail Bakalianos and Tomas Grahn
...
data_root = f'data/{dataset}/{num_frames}_train'
data_root_val = f'data/{dataset}/{num_frames}_validation'
ann_file_train = f'data/{dataset}/{num_frames}_train.txt'
ann_file_val = f'data/{dataset}/{num_frames}_validation.txt'
ann_file_test = f'data/{dataset}/{num_frames}_validation.txt'
